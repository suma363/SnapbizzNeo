...
public class FailCreatePurchase_Test extends BaseClass {
    WebDriverUtility wu = new WebDriverUtility();
    ExcelUtility eu = new ExcelUtility();
    JavaUtility ju = new JavaUtility();

    @Test
    public void addDistributor() throws Throwable {
        ...
        int row = 1;
        // Intensionally i am failing this test case [cell number giving 10 instead of 0]
        String name = eu.getDataFromExcel("distributorSheet", row, 10);
